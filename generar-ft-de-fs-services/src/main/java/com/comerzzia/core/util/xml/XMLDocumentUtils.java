...
public final class XMLDocumentUtils extends Exception {
    ...
    public static String getTagValue(Element element, String tagName, boolean optional) throws XMLDocumentException {
        String returnString = "";
        ...
        if (!optional) {
            throw new XMLDocumentException("El elemento " + element.getTagName() + " no contiene el tag " + tagName);
        }
        return returnString;
    }

    public static String getTagValueAsString(Element element, String tagName, boolean optional) throws XMLDocumentException {
        return getTagValue(element, tagName, optional);
    }

    public static int getTagValueAsInt(Element element, String tagName, boolean optional) throws XMLDocumentException {
    ...
    public static Long getTagValueAsLong(Element element, String tagName, boolean optional) throws XMLDocumentException {
        String entero = getTagValue(element, tagName, optional);
        if (entero.length() == 0) {
            return 0L;
        }
    ...
    public static Double getTagValueAsDouble(Element element, String tagName, boolean optional) throws XMLDocumentException {
        String entero = getTagValue(element, tagName, optional);
        if (entero.length() == 0) {
            return 0.0;
        }
    ...
    public static boolean getTagValueAsBoolean(Element element, String tagName, boolean optional) throws XMLDocumentException {
        return Boolean.valueOf(getTagValue(element, tagName, optional));
    }

    public static Node getNode(Element element, String name, boolean optional) throws XMLDocumentException {
        Node node = null;
        ...
        if (!optional) {
            throw new XMLDocumentException("El elemento " + element.getTagName() + " no contiene el nodo " + name);
        }
        return node;
    }

    public static List<Element> getChildElements(Element element) throws XMLDocumentException {
        List<Element> lstNodos = new ArrayList<>();
        Node node = null;
        for (node = element.getFirstChild(); node != null; node = node.getNextSibling()) {
            if (node.getNodeType() == Node.ELEMENT_NODE) {
    ...
    public static Element getElement(Element element, String name, boolean optional) throws XMLDocumentException {
    ...
    public static String getAttribute(Element element, String name, boolean optional) throws XMLDocumentException {
        ...
        if (value == null || value.length() == 0) {
            if (!optional) {
                throw new XMLDocumentException("El elemento " + element.getTagName() + " no contiene el atributo " + name);
            } else {
                value = "";
            }
        }
